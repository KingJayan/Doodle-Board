...
function defineTheme(s: ThemeSpec): ThemeDef {
  ...
  const vars: Record<string, string> = {
    ...
    '--accent': accent,
    '--danger': dark ? '#ff7a7a' : '#dc2626',
    '--danger-strong': dark ? '#ff5f5f' : '#b91c1c',
    '--danger-tint': dark ? 'rgba(255,122,122,0.16)' : 'rgba(220,38,38,0.1)',
    '--scrim': dark ? 'rgba(0,0,0,0.6)' : 'rgba(0,0,0,0.4)',
...
const SPECS: ThemeSpec[] = [
...

  {
    ...
    radius: '6px',
    tilt: 0,
    tape: 'rgba(255,255,255,0.07)',
    accent2: '#888888',
    cardShadow: '0 1px 2px rgba(0,0,0,0.9), 0 0 0 1px rgba(255,255,255,0.07)',
    motifs: [
      'M26 50 H 74 M 50 26 V 74',
      'M30 30 H 70 V 70 H 30 Z',
      'M50 26 L 74 74 L 26 74 Z',
      'M50 26 a 24 24 0 1 0 0.1 0',
      'M26 50 H 74 M 40 36 L 26 50 L 40 64 M 60 36 L 74 50 L 60 64',
      'M30 30 L 70 70 M 70 30 L 30 70',
      'M50 22 L 78 50 L 50 78 L 22 50 Z',
      'M38 38 H 62 V 62 H 38 Z M 50 38 V 26 M 50 62 V 74 M 38 50 H 26 M 62 50 H 74',
    ],
  },

  {
    name: 'sherbet',
    label: 'Cosmic Sherbet',
    emoji: '🍑',
    icon: 'sparkles',
    dark: false,
    paper: '#F6F5F8',
    ...
    radius: '28px',
    tilt: 1.4,
    tape: 'rgba(255,107,74,0.22)',
    accent2: '#9B5DE5',
    cardShadow: '2px 4px 16px rgba(45,27,78,0.12)',
    motifs: [
      'M18 50 Q 34 22 50 50 Q 66 78 82 50',
      'M50 24 C 30 24 22 38 22 50 C 22 66 34 76 50 76 C 66 76 78 66 78 50 C 78 34 70 24 50 24 Z M 42 44 C 42 36 58 36 58 44',
      'M22 62 Q 36 28 50 50 Q 64 72 78 38',
      'M50 26 C 42 26 36 32 36 40 C 36 52 50 56 50 68 C 50 56 64 52 64 40 C 64 32 58 26 50 26 Z',
      'M26 50 Q 38 30 50 50 T 74 50 M 26 58 Q 38 38 50 58 T 74 58',
      'M50 28 a8 8 0 1 0 0.1 0 M 72 44 a6 6 0 1 0 0.1 0 M 28 44 a6 6 0 1 0 0.1 0 M 62 68 a5 5 0 1 0 0.1 0 M 38 68 a5 5 0 1 0 0.1 0',
      'M50 26 C 26 34 26 66 50 74 C 74 66 74 34 50 26 Z M 50 26 Q 62 50 50 74 M 50 26 Q 38 50 50 74',
      'M22 40 Q 36 26 50 40 Q 64 54 78 40 M 22 60 Q 36 46 50 60 Q 64 74 78 60',
    ],
  },
